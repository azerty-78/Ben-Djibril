export const servicesTranslations = {
  en: {
    ...
    serviceEcom: { 
      ...
      feature1: 'Payment integration', 
      feature2: 'Inventory management', 
      feature3: 'Shopping cart', 
    ...
    serviceInventory: { 
      ...
      desc: 'Complete stock management system for your business', 
      feature1: 'Real-time stock tracking', 
      feature2: 'Low stock alerts', 
      feature3: 'Product categorization', 
      feature4: 'Stock reports & analytics',
      detailedDescription: 'Complete inventory management system to track your products in real time, manage entries and exits, generate reports and optimize your stock levels. Ideal for retail stores, warehouses and distribution centers.',
      valueProposition: 'Reduce stockouts and overstock, optimize your inventory costs and save time with automated stock management.',
      possibleFeatures: [
    ...
    serviceRestaurant: { 
      ...
      desc: 'Complete solution for restaurant and food service businesses', 
      feature1: 'Menu management', 
      feature2: 'Table reservation system', 
      feature3: 'Order tracking', 
      feature4: 'Kitchen display system',
      detailedDescription: 'Complete restaurant management solution to optimize your operations from order taking to delivery. Manage your menu, reservations, orders, kitchen display and payments all in one place.',
      valueProposition: 'Improve your service speed, reduce errors and increase customer satisfaction with an integrated restaurant management system.',
      possibleFeatures: [
    ...
    serviceBilling: { 
      ...
      desc: 'Professional invoicing and billing system', 
      feature1: 'Invoice generation', 
      feature2: 'Payment tracking', 
      feature3: 'Tax management', 
      feature4: 'Financial reports',
      detailedDescription: 'Professional invoicing and billing software to create, send and track your invoices. Manage your customers, track payments, handle taxes and generate financial reports.',
      valueProposition: 'Save time on administrative tasks, improve your cash flow management and maintain professional invoices compliant with local regulations.',
      possibleFeatures: [
        ...
        'Invoice templates',
        'Financial reports (sales, outstanding)',
    ...
    servicePharmacy: { title: 'Pharmacy Management', desc: 'Complete pharmacy management system', feature1: 'Drug inventory tracking', feature2: 'Prescription management', feature3: 'Expiry date alerts', feature4: 'Patient records' },
    serviceGym: { title: 'Gym Management', desc: 'Fitness center and gym management system', feature1: 'Member management', feature2: 'Subscription tracking', feature3: 'Class scheduling', feature4: 'Payment processing' },
    serviceSalon: { 
      title: 'Salon & Beauty Management', 
      desc: 'Beauty salon and spa management system', 
      feature1: 'Appointment scheduling', 
      feature2: 'Service catalog', 
      feature3: 'Staff management', 
      feature4: 'Customer history',
      detailedDescription: 'Complete management solution for beauty salons and spas. Manage appointments, services, staff schedules, customer history and payments all in one integrated system.',
      valueProposition: 'Optimize your salon operations, reduce no-shows, improve customer satisfaction and increase revenue with automated appointment management and customer tracking.',
      possibleFeatures: [
    ...
    serviceAccounting: { title: 'Accounting Software', desc: 'Complete accounting and financial management', feature1: 'General ledger', feature2: 'Accounts payable/receivable', feature3: 'Financial statements', feature4: 'Tax compliance' },
    servicePayroll: { title: 'Payroll Management', desc: 'Employee payroll and HR management system', feature1: 'Salary calculation', feature2: 'Tax deductions', feature3: 'Payslip generation', feature4: 'Employee records' },
    serviceMobileMoney: { title: 'Mobile Money Integration', desc: 'Mobile money payment integration (Orange Money, MTN Mobile Money)', feature1: 'Payment gateway', feature2: 'Transaction tracking', feature3: 'Balance management', feature4: 'Payment history' },
    serviceMarket: { title: 'Market Management', desc: 'Market and vendor management system', feature1: 'Vendor registration', feature2: 'Stall management', feature3: 'Fee collection', feature4: 'Market analytics' },
    serviceParking: { title: 'Parking Management', desc: 'Parking lot and space management system', feature1: 'Space allocation', feature2: 'Payment processing', feature3: 'Access control', feature4: 'Revenue tracking' },
    serviceSchool: { title: 'School Management', desc: 'Educational institution management system', feature1: 'Student management', feature2: 'Grade tracking', feature3: 'Fee management', feature4: 'Report cards' },
    serviceHospital: { title: 'Hospital Management', desc: 'Healthcare facility management system', feature1: 'Patient records', feature2: 'Appointment scheduling', feature3: 'Medical billing', feature4: 'Pharmacy integration' },
    searchPlaceholder: 'Search for a service...',
    searchResults: { found: 'service found', foundPlural: 'services found' },
  },
  fr: {
    ...
    serviceEcom: { 
      title: 'E-commerce', 
      desc: 'Boutiques en ligne qui convertissent', 
      feature1: 'Intégration paiement', 
      feature2: 'Gestion des stocks', 
      feature3: 'Panier d\'achat', 
      feature4: 'Tableau de bord admin',
    ...
    servicePharmacy: { title: 'Gestion de Pharmacie', desc: 'Système complet de gestion de pharmacie', feature1: 'Suivi des médicaments', feature2: 'Gestion des ordonnances', feature3: 'Alertes de péremption', feature4: 'Dossiers patients' },
    serviceGym: { title: 'Gestion de Salle de Sport', desc: 'Système de gestion de salle de sport et fitness', feature1: 'Gestion des membres', feature2: 'Suivi des abonnements', feature3: 'Planification des cours', feature4: 'Traitement des paiements' },
    serviceSalon: { 
      title: 'Gestion de Salon & Beauté', 
      desc: 'Système de gestion de salon de beauté et spa', 
      feature1: 'Planification des rendez-vous', 
      feature2: 'Catalogue de services', 
      feature3: 'Gestion du personnel', 
      feature4: 'Historique clients',
      detailedDescription: 'Solution complète de gestion pour salons de beauté et spas. Gérez les rendez-vous, services, planning du personnel, historique clients et paiements dans un système intégré.',
      valueProposition: 'Optimisez vos opérations de salon, réduisez les rendez-vous manqués, améliorez la satisfaction client et augmentez vos revenus avec une gestion automatisée des rendez-vous et suivi client.',
      possibleFeatures: [
    ...
    serviceAccounting: { title: 'Logiciel de Comptabilité', desc: 'Comptabilité et gestion financière complète', feature1: 'Grand livre général', feature2: 'Comptes clients/fournisseurs', feature3: 'États financiers', feature4: 'Conformité fiscale' },
    servicePayroll: { title: 'Gestion de Paie', desc: 'Système de gestion de paie et RH', feature1: 'Calcul des salaires', feature2: 'Déductions fiscales', feature3: 'Génération de bulletins', feature4: 'Dossiers employés' },
    serviceMobileMoney: { title: 'Intégration Mobile Money', desc: 'Intégration des paiements mobile money (Orange Money, MTN Mobile Money)', feature1: 'Passerelle de paiement', feature2: 'Suivi des transactions', feature3: 'Gestion des soldes', feature4: 'Historique des paiements' },
    serviceMarket: { title: 'Gestion de Marché', desc: 'Système de gestion de marché et vendeurs', feature1: 'Enregistrement des vendeurs', feature2: 'Gestion des stands', feature3: 'Collecte des frais', feature4: 'Analyses du marché' },
    serviceParking: { title: 'Gestion de Parking', desc: 'Système de gestion de parking et espaces', feature1: 'Allocation des espaces', feature2: 'Traitement des paiements', feature3: 'Contrôle d\'accès', feature4: 'Suivi des revenus' },
    serviceSchool: { title: 'Gestion Scolaire', desc: 'Système de gestion d\'établissement scolaire', feature1: 'Gestion des élèves', feature2: 'Suivi des notes', feature3: 'Gestion des frais', feature4: 'Bulletins de notes' },
    serviceHospital: { title: 'Gestion Hospitalière', desc: 'Système de gestion d\'établissement de santé', feature1: 'Dossiers patients', feature2: 'Planification des rendez-vous', feature3: 'Facturation médicale', feature4: 'Intégration pharmacie' },
    searchPlaceholder: 'Rechercher un service...',
    searchResults: { found: 'service trouvé', foundPlural: 'services trouvés' },
  },
}
