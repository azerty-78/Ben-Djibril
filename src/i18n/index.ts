    ...
    translation: {
      ...
      services: {
        ...
        saas: {
          goodDeal: {
            name: 'Good Deal',
            price: '35,000 XAF / month',
            description: 'Ideal to launch your project at a low cost.',
            feature1: 'Hosting, maintenance and security included',
          ...
          normal: {
            name: 'Normal',
            price: '45,000 XAF / month',
            description: 'For businesses that need more flexibility and follow-up.',
            feature1: 'Everything in Good Deal',
          ...
          premium: {
            name: 'Premium',
            price: '55,000 XAF / month',
            description: 'Maximum peace of mind and close support.',
            feature1: 'Everything in Normal',
    ...
    translation: {
      ...
      services: {
        ...
        saas: {
          goodDeal: {
            name: 'Good Deal',
            price: '35 000 XAF / mois',
            description: 'Idéal pour lancer votre projet à moindre coût.',
            feature1: 'Hébergement, maintenance et sécurité inclus',
          ...
          normal: {
            name: 'Normal',
            price: '45 000 XAF / mois',
            description: 'Pour les entreprises qui ont besoin de plus de suivi et de flexibilité.',
            feature1: 'Tout ce qu’il y a dans Good Deal',
          ...
          premium: {
            name: 'Premium',
            price: '55 000 XAF / mois',
            description: 'Tranquillité maximale et accompagnement rapproché.',
            feature1: 'Tout ce qu’il y a dans Normal',
