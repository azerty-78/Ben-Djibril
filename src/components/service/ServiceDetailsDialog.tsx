    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Content */}
          <div className="px-3 xs:px-4 sm:px-6 md:px-8 py-4 xs:py-5 sm:py-6 md:py-7 space-y-4 xs:space-y-5 sm:space-y-6 max-h-[calc(95vh-140px)] xs:max-h-[calc(90vh-160px)] sm:max-h-[calc(90vh-180px)] overflow-y-auto bg-white dark:bg-secondary-900 scrollbar-thin scrollbar-thumb-secondary-300 dark:scrollbar-thumb-secondary-600 scrollbar-track-transparent">
            {/* Overview */}
          ...
          {/* Footer actions */}
          <div className="sticky bottom-0 px-3 xs:px-4 sm:px-6 md:px-8 py-2.5 xs:py-3 sm:py-4 border-t border-secondary-100 dark:border-secondary-800 bg-white dark:bg-secondary-900 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] dark:shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.3)] z-10">
            <div className="flex flex-row gap-1.5 xs:gap-2 sm:gap-3 justify-end items-center">
              <button
                type="button"
                onClick={onClose}
                className="px-3 xs:px-4 sm:px-5 py-2 xs:py-2.5 sm:py-3 rounded-lg border border-secondary-300 dark:border-secondary-600 text-[0.7rem] xs:text-xs sm:text-sm font-medium text-secondary-700 dark:text-secondary-200 hover:bg-secondary-100/70 dark:hover:bg-secondary-800 transition-all duration-200 whitespace-nowrap"
              >
