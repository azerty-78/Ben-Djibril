...
function CertificationsSection() {
  ...
  return (
    <section id="certifications" data-section="certifications" className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-secondary-900 dark:via-secondary-800 dark:to-secondary-900 relative overflow-hidden">
