    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-secondary-900 dark:via-secondary-800 dark:to-secondary-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -bottom-12 sm:-bottom-16 -left-8 sm:-left-10 w-48 sm:w-64 md:w-96 h-48 sm:h-64 md:h-96 bg-accent-200 dark:bg-accent-600 rounded-full blur-3xl"
        />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-20 left-10 sm:left-20 w-16 h-16 sm:w-20 sm:h-20 text-primary-300 dark:text-primary-500 opacity-40"
        >
          <CodeBracketIcon />
        </motion.div>
        <motion.div
          ...
          className="absolute top-40 right-10 sm:right-20 w-12 h-12 sm:w-16 sm:h-16 text-accent-300 dark:text-accent-500 opacity-40"
        >
          <RocketLaunchIcon />
        </motion.div>
        <motion.div
      ...
      <div className="container mx-auto px-4 sm:px-6 relative">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg sm:text-xl md:text-2xl text-secondary-600 dark:text-secondary-300 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed"
          >
            {t('projects.subtitle')}
          </motion.p>
          ...
          <motion.p
            variants={itemVariants}
            className="text-base sm:text-lg text-secondary-500 dark:text-secondary-400 mb-10 sm:mb-12 max-w-xl mx-auto"
          >
          ...
          >
            <Link
              to="/contact"
              className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-3.5 flex items-center gap-2 group w-full sm:w-auto justify-center shadow-lg hover:shadow-xl transition-all"
            >
            ...
            <a
              href="#projects-grid"
              className="btn-secondary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-3.5 w-full sm:w-auto text-center"
            >
          ...
          <motion.div
            variants={itemVariants}
            className="mt-12 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-3xl mx-auto"
          >
            {[
