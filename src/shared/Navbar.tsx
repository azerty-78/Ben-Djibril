          ...
          <div className="container mx-auto px-3 sm:px-4 lg:px-6">
            <div className="flex items-center justify-between py-2.5 sm:py-3">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-shrink">
                <NavLink to="/" className="text-lg sm:text-xl font-bold gradient-text whitespace-nowrap">Ben Djibril</NavLink>
              </div>
              ...
              <div className="lg:hidden flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                <LanguageSwitcher />
                <ThemeToggle />
                <Disclosure.Button aria-label="Menu" className="p-2 rounded-lg bg-secondary-100 dark:bg-secondary-800 text-secondary-800 dark:text-secondary-100 hover:bg-secondary-200 dark:hover:bg-secondary-700 transition-colors flex-shrink-0">
                  {open ? <XMarkIcon className="w-5 h-5 sm:w-6 sm:h-6" /> : <Bars3Icon className="w-5 h-5 sm:w-6 sm:h-6" />}
                </Disclosure.Button>
              </div>
            </div>

            <Disclosure.Panel className="lg:hidden pb-3 sm:pb-4">
              <MobileMenu />
            </Disclosure.Panel>
          </div>
        )}
